...
class FaceMeshRefined extends AiModel {
  FaceMeshRefined({this.interpreter}) {
    loadModel();
  }
  ...
  Future<void> loadModel() async {
    try {
      interpreter ??= await createInterpreterFromAsset(ModelFile.faceRefined);
      ...
      print('Output shape: $outputShapes');
    } catch (e) {
...
Map<String, dynamic>? runFaceMeshRefined(Map<String, dynamic> params) {
  final faceMesh = FaceMeshRefined(
